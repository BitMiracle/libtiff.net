...
namespace BitMiracle.LibTiff.Classic
{
    ...
    partial class Tiff
    {
        ...
        {
            new TiffFieldInfo(TiffTag.SUBFILETYPE, 1, 1, TiffType.LONG, FieldBit.FIELD_SUBFILETYPE, true, false, "SubfileType"), 
            /* XXX SHORT for compatibility w/ old versions of the library */
            new TiffFieldInfo(TiffTag.SUBFILETYPE, 1, 1, TiffType.SHORT, FieldBit.FIELD_SUBFILETYPE, true, false, "SubfileType"), 
            new TiffFieldInfo(TiffTag.OSUBFILETYPE, 1, 1, TiffType.SHORT, FieldBit.FIELD_SUBFILETYPE, true, false, "OldSubfileType"), 
            new TiffFieldInfo(TiffTag.IMAGEWIDTH, 1, 1, TiffType.LONG, FieldBit.FIELD_IMAGEDIMENSIONS, false, false, "ImageWidth"), 
            new TiffFieldInfo(TiffTag.IMAGEWIDTH, 1, 1, TiffType.SHORT, FieldBit.FIELD_IMAGEDIMENSIONS, false, false, "ImageWidth"), 
            new TiffFieldInfo(TiffTag.IMAGELENGTH, 1, 1, TiffType.LONG, FieldBit.FIELD_IMAGEDIMENSIONS, true, false, "ImageLength"), 
            new TiffFieldInfo(TiffTag.IMAGELENGTH, 1, 1, TiffType.SHORT, FieldBit.FIELD_IMAGEDIMENSIONS, true, false, "ImageLength"), 
            new TiffFieldInfo(TiffTag.BITSPERSAMPLE, -1, -1, TiffType.SHORT, FieldBit.FIELD_BITSPERSAMPLE, false, false, "BitsPerSample"), 
            /* XXX LONG for compatibility with some broken TIFF writers */
            new TiffFieldInfo(TiffTag.BITSPERSAMPLE, -1, -1, TiffType.LONG, FieldBit.FIELD_BITSPERSAMPLE, false, false, "BitsPerSample"), 
            new TiffFieldInfo(TiffTag.COMPRESSION, -1, 1, TiffType.SHORT, FieldBit.FIELD_COMPRESSION, false, false, "Compression"), 
            /* XXX LONG for compatibility with some broken TIFF writers */
            new TiffFieldInfo(TiffTag.COMPRESSION, -1, 1, TiffType.LONG, FieldBit.FIELD_COMPRESSION, false, false, "Compression"), 
            new TiffFieldInfo(TiffTag.PHOTOMETRIC, 1, 1, TiffType.SHORT, FieldBit.FIELD_PHOTOMETRIC, false, false, "PhotometricInterpretation"), 
            /* XXX LONG for compatibility with some broken TIFF writers */
            new TiffFieldInfo(TiffTag.PHOTOMETRIC, 1, 1, TiffType.LONG, FieldBit.FIELD_PHOTOMETRIC, false, false, "PhotometricInterpretation"), 
            new TiffFieldInfo(TiffTag.THRESHHOLDING, 1, 1, TiffType.SHORT, FieldBit.FIELD_THRESHHOLDING, true, false, "Threshholding"), 
            ...
            new TiffFieldInfo(TiffTag.FILLORDER, 1, 1, TiffType.SHORT, FieldBit.FIELD_FILLORDER, false, false, "FillOrder"), 
            ...
            new TiffFieldInfo(TiffTag.STRIPOFFSETS, -1, -1, TiffType.LONG, FieldBit.FIELD_STRIPOFFSETS, false, false, "StripOffsets"), 
            new TiffFieldInfo(TiffTag.STRIPOFFSETS, -1, -1, TiffType.SHORT, FieldBit.FIELD_STRIPOFFSETS, false, false, "StripOffsets"), 
            new TiffFieldInfo(TiffTag.ORIENTATION, 1, 1, TiffType.SHORT, FieldBit.FIELD_ORIENTATION, false, false, "Orientation"), 
            new TiffFieldInfo(TiffTag.SAMPLESPERPIXEL, 1, 1, TiffType.SHORT, FieldBit.FIELD_SAMPLESPERPIXEL, false, false, "SamplesPerPixel"), 
            new TiffFieldInfo(TiffTag.ROWSPERSTRIP, 1, 1, TiffType.LONG, FieldBit.FIELD_ROWSPERSTRIP, false, false, "RowsPerStrip"), 
            new TiffFieldInfo(TiffTag.ROWSPERSTRIP, 1, 1, TiffType.SHORT, FieldBit.FIELD_ROWSPERSTRIP, false, false, "RowsPerStrip"), 
            new TiffFieldInfo(TiffTag.STRIPBYTECOUNTS, -1, -1, TiffType.LONG, FieldBit.FIELD_STRIPBYTECOUNTS, false, false, "StripByteCounts"), 
            new TiffFieldInfo(TiffTag.STRIPBYTECOUNTS, -1, -1, TiffType.SHORT, FieldBit.FIELD_STRIPBYTECOUNTS, false, false, "StripByteCounts"), 
            new TiffFieldInfo(TiffTag.MINSAMPLEVALUE, -2, -1, TiffType.SHORT, FieldBit.FIELD_MINSAMPLEVALUE, true, false, "MinSampleValue"), 
            new TiffFieldInfo(TiffTag.MAXSAMPLEVALUE, -2, -1, TiffType.SHORT, FieldBit.FIELD_MAXSAMPLEVALUE, true, false, "MaxSampleValue"), 
            new TiffFieldInfo(TiffTag.XRESOLUTION, 1, 1, TiffType.RATIONAL, FieldBit.FIELD_RESOLUTION, true, false, "XResolution"), 
            new TiffFieldInfo(TiffTag.YRESOLUTION, 1, 1, TiffType.RATIONAL, FieldBit.FIELD_RESOLUTION, true, false, "YResolution"), 
            new TiffFieldInfo(TiffTag.PLANARCONFIG, 1, 1, TiffType.SHORT, FieldBit.FIELD_PLANARCONFIG, false, false, "PlanarConfiguration"), 
            new TiffFieldInfo(TiffTag.PAGENAME, -1, -1, TiffType.ASCII, FieldBit.Custom, true, false, "PageName"), 
            new TiffFieldInfo(TiffTag.XPOSITION, 1, 1, TiffType.RATIONAL, FieldBit.FIELD_POSITION, true, false, "XPosition"), 
            new TiffFieldInfo(TiffTag.YPOSITION, 1, 1, TiffType.RATIONAL, FieldBit.FIELD_POSITION, true, false, "YPosition"), 
            ...
            new TiffFieldInfo(TiffTag.RESOLUTIONUNIT, 1, 1, TiffType.SHORT, FieldBit.FIELD_RESOLUTIONUNIT, true, false, "ResolutionUnit"), 
            new TiffFieldInfo(TiffTag.PAGENUMBER, 2, 2, TiffType.SHORT, FieldBit.FIELD_PAGENUMBER, true, false, "PageNumber"), 
            new TiffFieldInfo(TiffTag.COLORRESPONSEUNIT, 1, 1, TiffType.SHORT, FieldBit.Ignore, true, false, "ColorResponseUnit"), 
            new TiffFieldInfo(TiffTag.TRANSFERFUNCTION, -1, -1, TiffType.SHORT, FieldBit.FIELD_TRANSFERFUNCTION, true, false, "TransferFunction"), 
            ...
            new TiffFieldInfo(TiffTag.COLORMAP, -1, -1, TiffType.SHORT, FieldBit.FIELD_COLORMAP, true, false, "ColorMap"), 
            new TiffFieldInfo(TiffTag.HALFTONEHINTS, 2, 2, TiffType.SHORT, FieldBit.FIELD_HALFTONEHINTS, true, false, "HalftoneHints"), 
            new TiffFieldInfo(TiffTag.TILEWIDTH, 1, 1, TiffType.LONG, FieldBit.FIELD_TILEDIMENSIONS, false, false, "TileWidth"), 
            new TiffFieldInfo(TiffTag.TILEWIDTH, 1, 1, TiffType.SHORT, FieldBit.FIELD_TILEDIMENSIONS, false, false, "TileWidth"), 
            new TiffFieldInfo(TiffTag.TILELENGTH, 1, 1, TiffType.LONG, FieldBit.FIELD_TILEDIMENSIONS, false, false, "TileLength"), 
            new TiffFieldInfo(TiffTag.TILELENGTH, 1, 1, TiffType.SHORT, FieldBit.FIELD_TILEDIMENSIONS, false, false, "TileLength"), 
            new TiffFieldInfo(TiffTag.TILEOFFSETS, -1, 1, TiffType.LONG, FieldBit.FIELD_STRIPOFFSETS, false, false, "TileOffsets"), 
            new TiffFieldInfo(TiffTag.TILEBYTECOUNTS, -1, 1, TiffType.LONG, FieldBit.FIELD_STRIPBYTECOUNTS, false, false, "TileByteCounts"), 
            new TiffFieldInfo(TiffTag.TILEBYTECOUNTS, -1, 1, TiffType.SHORT, FieldBit.FIELD_STRIPBYTECOUNTS, false, false, "TileByteCounts"), 
            new TiffFieldInfo(TiffTag.SUBIFD, -1, -1, TiffType.IFD, FieldBit.FIELD_SUBIFD, true, true, "SubIFD"), 
            new TiffFieldInfo(TiffTag.SUBIFD, -1, -1, TiffType.LONG, FieldBit.FIELD_SUBIFD, true, true, "SubIFD"), 
            new TiffFieldInfo(TiffTag.INKSET, 1, 1, TiffType.SHORT, FieldBit.Custom, false, false, "InkSet"), 
            new TiffFieldInfo(TiffTag.INKNAMES, -1, -1, TiffType.ASCII, FieldBit.FIELD_INKNAMES, true, true, "InkNames"), 
            ...
            new TiffFieldInfo(TiffTag.EXTRASAMPLES, -1, -1, TiffType.SHORT, FieldBit.FIELD_EXTRASAMPLES, false, true, "ExtraSamples"), 
            /* XXX for bogus Adobe Photoshop v2.5 files */
            new TiffFieldInfo(TiffTag.EXTRASAMPLES, -1, -1, TiffType.BYTE, FieldBit.FIELD_EXTRASAMPLES, false, true, "ExtraSamples"), 
            new TiffFieldInfo(TiffTag.SAMPLEFORMAT, -1, -1, TiffType.SHORT, FieldBit.FIELD_SAMPLEFORMAT, false, false, "SampleFormat"), 
            new TiffFieldInfo(TiffTag.SMINSAMPLEVALUE, -2, -1, TiffType.ANY, FieldBit.FIELD_SMINSAMPLEVALUE, true, false, "SMinSampleValue"), 
            new TiffFieldInfo(TiffTag.SMAXSAMPLEVALUE, -2, -1, TiffType.ANY, FieldBit.FIELD_SMAXSAMPLEVALUE, true, false, "SMaxSampleValue"), 
            ...
            new TiffFieldInfo(TiffTag.DATATYPE, -2, -1, TiffType.SHORT, FieldBit.FIELD_SAMPLEFORMAT, false, false, "DataType"), 
            new TiffFieldInfo(TiffTag.IMAGEDEPTH, 1, 1, TiffType.LONG, FieldBit.FIELD_IMAGEDEPTH, false, false, "ImageDepth"), 
            new TiffFieldInfo(TiffTag.IMAGEDEPTH, 1, 1, TiffType.SHORT, FieldBit.FIELD_IMAGEDEPTH, false, false, "ImageDepth"), 
            new TiffFieldInfo(TiffTag.TILEDEPTH, 1, 1, TiffType.LONG, FieldBit.FIELD_TILEDEPTH, false, false, "TileDepth"), 
            new TiffFieldInfo(TiffTag.TILEDEPTH, 1, 1, TiffType.SHORT, FieldBit.FIELD_TILEDEPTH, false, false, "TileDepth"), 
            /* end SGI tags */
            /* begin Pixar tags */
