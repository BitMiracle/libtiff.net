...
namespace LibJpeg.NET
{
    ...
    abstract class jpeg_entropy_decoder
    {
        ...
        */
        ...
        protected void BITREAD_LOAD_STATE(ref bitread_perm_state bitstate, ref int get_buffer, ref int bits_left, ref bitread_working_state br_state)
        {
        ...
        */
        protected static bool HUFF_DECODE(ref int result, bitread_working_state state, d_derived_tbl htbl, ref int get_buffer, ref int bits_left)
        {
            int nb = 0;
            bool doSlow = false;
